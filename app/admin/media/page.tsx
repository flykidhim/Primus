  ...
  return (
    <div className="py-8 space-y-6">
      ...
      <div className="rounded-2xl border p-4">
        <h2 className="font-semibold mb-2">Create Media</h2>
        <form action="/api/admin/media/create" method="post" className="grid md:grid-cols-2 gap-3">
          <input name="title" placeholder="title" className="border rounded-xl px-3 py-2" /><input name="type" placeholder="type" className="border rounded-xl px-3 py-2" /><input name="url" placeholder="url" className="border rounded-xl px-3 py-2" />
